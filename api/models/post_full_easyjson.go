...
func easyjson95e8944cDecodeGithubComHuvalkTechDbHuvalkApiModels(in *jlexer.Lexer, out *PostFull) {
...
func easyjson95e8944cEncodeGithubComHuvalkTechDbHuvalkApiModels(out *jwriter.Writer, in PostFull) {
	out.RawByte('{')
	first := true
	_ = first
	if in.Author != nil {
...
func (v PostFull) MarshalJSON() ([]byte, error) {
	w := jwriter.Writer{}
	easyjson95e8944cEncodeGithubComHuvalkTechDbHuvalkApiModels(&w, v)
...
func (v *PostFull) UnmarshalJSON(data []byte) error {
	...
	easyjson95e8944cDecodeGithubComHuvalkTechDbHuvalkApiModels(&r, v)
	return r.Error()
}

// UnmarshalEasyJSON supports easyjson.Unmarshaler interface
func (v *PostFull) UnmarshalEasyJSON(l *jlexer.Lexer) {
	easyjson95e8944cDecodeGithubComHuvalkTechDbHuvalkApiModels(l, v)
}
